...
import { defaultProduct, defaultProduct2, defaultProduct3, defaultProduct4, defaultProduct5 } from '../../screens/home/product-list/dummy';
...
const ProductListComponent=()=>{
  const baseURL = 'http://localhost:5000/getProductList';
	const [{ data: getData, loading: getLoading, error: getError },executeGet] =useAxios<GetImageProductListRes[]>(
		{
			method: 'GET',
